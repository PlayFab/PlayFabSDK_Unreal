...
/// </remarks>
class PLAYFABSERVICES_API FServerGetPlayersInSegmentAsyncTask : public FXAsyncTask
{
public:
	FServerGetPlayersInSegmentAsyncTask(
	_In_ FPFEntityHandle TitleEntityHandle,
...
private:
	...
	FPFSegmentsGetPlayersInSegmentRequest Request;
	
	FOnServerGetPlayersInSegmentCompleted Delegate;
