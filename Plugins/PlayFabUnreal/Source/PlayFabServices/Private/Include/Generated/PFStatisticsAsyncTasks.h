...
/// </remarks>
class PLAYFABSERVICES_API FUnlinkAggregationSourceFromStatisticAsyncTask : public FXAsyncTask
{
public:
	FUnlinkAggregationSourceFromStatisticAsyncTask(
	_In_ FPFEntityHandle EntityHandle,
...
private:
	...
	FPFStatisticsUnlinkAggregationSourceFromStatisticRequest Request;
	
	FOnUnlinkAggregationSourceFromStatisticCompleted Delegate;
